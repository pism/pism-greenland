...
extract_interface.py --ensemble_file ../uq/jib_fractures.csv -e 3413 -t ice_ocean -o ../io/io_masked_ex_${file}_1985-7-16.gpkg mask_masked_ex_${file}_1985-7-16.nc
extract_interface.py --ensemble_file ../uq/jib_fractures.csv -e 3413 -t ice_ocean -o ../io/io_masked_ex_${file}_2009-7-16.gpkg mask_masked_ex_${file}_2009-7-16.nc
