...
cdo -f nc4 -z zip_2 seldate,1985-7-16 -selvar,$var masked_ex_${file}.nc ${var}_masked_ex_${file}_1985-7-16.nc
cdo -f nc4 -z zip_2 seldate,2009-7-16 -selvar,$var masked_ex_${file}.nc ${var}_masked_ex_${file}_2009-7-16.nc
done

cdo fldsum  masked_ex_${file}.nc fldsum_masked_ex_${file}.nc
cdo fldmean masked_ex_${file}.nc fldmean_masked_ex_${file}.nc

extract_interface.py --ensemble_file ../uq/jib_uq_samples_10.csv -e 3413 -t ice_ocean -o ../io/io_masked_ex_${file}_1985-7-16.gpkg mask_masked_ex_${file}_1985-7-16.nc
extract_interface.py --ensemble_file ../uq/jib_uq_samples_10.csv -e 3413 -t ice_ocean -o ../io/io_masked_ex_${file}_2009-7-16.gpkg mask_masked_ex_${file}_2009-7-16.nc
