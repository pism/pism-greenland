...
extract_interface.py --ensemble_file ../uq/jib_uq_borstadt_samples_20.csv -e 3413 -t ice_ocean -o ../io/io_masked_ex_${file}_1985-7-16.gpkg mask_masked_ex_${file}_1985-7-16.nc
