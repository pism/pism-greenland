...
grid = PISM.IceGrid.FromFile(ctx.ctx, input_file, ["thk"], PISM.CELL_CENTER)
...
ice_velocity.read(input_file, 0)   # 0 ==> first record of that file (if time-dependent)
...
geometry.ice_thickness.read(input_file, 0)
geometry.bed_elevation.read(input_file, 0)
