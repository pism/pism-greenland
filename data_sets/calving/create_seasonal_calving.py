...
def create_file(amplification_factor, filename: str, start_year : int = 1975, end_year : int = 2025, year_high: int = 2000):
...
for k, amplification_factor in enumerate(amplification_factors):
    filename = f"seasonal_calving_id_{k}_{start_year}_{end_year}.nc"
    calving = create_file(amplification_factor, filename, start_year, end_year, year_high)
    c.append(calving)
