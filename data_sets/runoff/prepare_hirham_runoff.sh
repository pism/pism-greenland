...
cdo -L -O -f nc4 --reduce_dim mergetime -setmisstoc,0 -setattribute,mrros@units="kg m-2 day-1" ${extracted_dir}/DMI-HIRHAM5_GL2_ERAI_1980_2014_MRROS_DM.nc -setattribute,mrros@units="kg m-2 day-1" -muldpm ${extracted_dir}/DMI-HIRHAM5_GL2_ERAI_2015_2016_MRROS_DM.nc DMI-HIRHAM5_GL2_ERAI_1980_2016_MRROS_DM.nc
