...
cdo -O -f nc4 --reduce_dim sellevel,0 -mergetime ${extracted_dir}/DMI-*.nc DMI-HIRHAM5_GL2_ERAI_1980_2016_MRROS_DM.nc
...
nc2cdo.py $grid_file
cdo remapycon,${grid_file} -setgrid,../../util/rotated_grid.txt DMI-HIRHAM5_GL2_ERAI_1980_2016_MRROS_DM.nc $tmp_file
