...
gebco=GEBCO_2023_sub_ice_topo.nc
...
# and works for grid resolutions up to 18km.
buffer_x=148650
buffer_y=130000
...
for GRID in 18000 15000 12000 9000 6000 4500 3600 3000 2400 1800 1500 1200 900 600 450 300 150; do
